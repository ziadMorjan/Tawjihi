...
export const checkCourseBelongToTeacherInCreate = asyncErrorHandler(async function (req, res, next) {
...
export const addCourseIdToReqBody = asyncErrorHandler(async function (req, res, next) {
    if (req.params.courseId)
        req.body.course = req.params.courseId;
    next();
});

export const addCourseIdToReqQuery = asyncErrorHandler(async function (req, res, next) {
    if (req.params.courseId)
